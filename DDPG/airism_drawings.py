# -*- coding: utf-8 -*-
"""
Created on Tue Dec  8 01:35:25 2020
...
# # plot points 
client.simPlotPoints(points = [Vector3r(20,60,-1)], color_rgba=[1, 0.0, 0.0, 1.0], size = 150, duration = 10, is_persistent = True)
time.sleep(5)
# client.simFlushPersistentMarkers()
# client.simPlotPoints(points = [Vector3r(x,y,-2) for x, y in zip(np.linspace(0,-40,20), np.linspace(0,-0,20))], color_rgba=[1.0, 0.0, 0.0, 1.0], size = 25, duration = 20.0, is_persistent = False)

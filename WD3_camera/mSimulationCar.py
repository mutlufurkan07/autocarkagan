...
class mSimulationCar:
    ...
    def getScreenDepthVis(self):
        ...
        # img2d = img2d[responses[0].height//3: 2 * responses[0].height//3, :]
    ...
    def take_action_and_collect_data(self):
        ...
        return self.pic, self.mcurrentSimOutput.astype(np.float32)
    ...
    def take_action_and_get_current_lidar_and_targetArray(self, TARGET_POS_X, TARGET_POS_Y, target_initial_distance):
        sem_pic, car_pos_lidar_data = self.take_action_and_collect_data()
        ...
        return sem_pic, state_numpy, state_tensor, curr_x, curr_y, curr_heading, isCollidedFlag, is_clear
